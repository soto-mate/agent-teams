...
TOPIC_ALREADY_OPEN = "Nothing to do: {channel} > {topic} is already open."
...
WAKE_HEADER = (
    ...
    "again next wake.\n"
    "If you need the answer to continue: ask and wait mid-wake, or end your reply with the "
    "question and a tag; the answer re-wakes you. Answering a persona's question: end your reply "
    "by tagging the asker, that one mention posts live and the asker's next reply cannot tag on. "
