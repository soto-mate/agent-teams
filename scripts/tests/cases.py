...
RUNNER_CMDS = [
    ("peter", None, None, None, None,
     ["claude", "-p", "--dangerously-skip-permissions",
      ...
      "--agents", '{"peter": {"description": "peter fixture", "prompt": "fixture body"}}',
